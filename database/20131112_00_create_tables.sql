...
CREATE TABLE `drug_allergies` (
  ...
  `modified` datetime NOT NULL,
  `patient_id` char(36) NOT NULL,
  `met` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `dpp_4i` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `glp_1ra` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `tzd` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `agi` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `colsvl` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `bcr_or` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `su_gln` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `insulin` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `sglt_2` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  `praml` enum('yes','unknown','no') collate utf8_unicode_ci NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `patient_id` (`patient_id`),
...
CREATE TABLE `medicines` (
  ...
  `unit` char(8) collate utf8_unicode_ci NOT NULL,
