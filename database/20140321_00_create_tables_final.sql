...
CREATE TABLE `patients` (
  ...
  `race` enum('African or African American','Asian or Asian American','Caucasian or European American','Native American or Native Alaskan','Hispanic or Latino','Pacific Islanders','Other Race') collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `medhistory_complaints` (
  ...
  `sleep_apnea` enum('yes','no') collate utf8_unicode_ci default NULL,
  `stress_incont` enum('yes','no') collate utf8_unicode_ci default NULL, 
  `family_hist_diabetes` enum('yes','no') collate utf8_unicode_ci default NULL, 
  `phys_active` enum('yes','no') collate utf8_unicode_ci default NULL, 
  PRIMARY KEY  (`id`),
...
CREATE TABLE `vitals_labs` (
  ...
  `gtt` int(11) default NULL,
  `fbg` int(11) default NULL,
  `ldl` int(11) default NULL,
  `hdl` int(11) default NULL ,
  `vhdl` int(11) default NULL,
