<h2>View Medicine</h2>
      <div class="col-md-8">
       ...
       <div style="padding:5px; display: inline-block;">
            <a href="<?php echo $this->webroot; ?>medicines/edit/<?php echo $medicine['Medicine']['id'] ?>" class="btn btn-primary" style="padding:5px;"><span class="glyphicon glyphicon-edit"></span> Update Medicine</a>
      </div>
      <div style="padding:5px; display: inline-block;">
            <a href="<?php echo $this->webroot; ?>medicines/delete/<?php echo $medicine['Medicine']['id'] ?>" data-confirm="Do you want to delete this medicine record?" data-method="delete" class="btn btn-primary" style="padding:5px;"><span class="glyphicon glyphicon-trash"></span> Delete Medicine</a>
      </div>       
    </div>
