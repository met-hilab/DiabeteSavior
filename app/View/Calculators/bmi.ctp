...
<form class="form-horizontal" id="bmiForm" role="form" ng-submit="submit">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input id="txtWeight" class="form-control" name="txtWeight" type="text" ng-focus="enterInput($event)" ng-keyup="weightKeyUp($event)">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input id="txtHeight" class="form-control" name="txtHeight" type="text" ng-focus="enterInput($event)" ng-keydown="heightKeyDown($event)">
    </div>
  </div>
