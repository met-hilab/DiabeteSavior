...
<p>
It has been estimated that there are more than 250,000 medical algorithms contained in biomedical peer-reviewed literature across all specialties of medicine. These algorithms range from simple calculations to complex outcome predictions. Standardization and automation of medical algorithms improves information sharing among health care providers, assists in the correct assessment, diagnosis, planning of therapy, and helps reduce medical errors. The HI Lab contributes to the improvement of healthcare by cataloging and implementing the medical algorithms. This website serves as an educational resource to provide up-to-date clinical/medical information and easy-to-use automated calculators.
</p>
<p>
Currently there is only one medical algorithm on this web site, and it is based on the glycemic control algorithm in the 
