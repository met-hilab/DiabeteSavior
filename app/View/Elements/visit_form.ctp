...
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.met', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Metformin: '))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.dpp_4i', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Dipeptidyl peptidase 4 inhibitors (DPP-4):'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.glp_1ra', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Glucagon-like peptide-1 receptor agonists (GLP-1):'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.tzd', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Thiazolidinediones (TZD):'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.agi', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Alpha-glucosidase inhibitors (AGIs):'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.colsvl', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Colesevelam:'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.bcr_or', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Bromocriptine Mesylate::'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.su_gln', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Sulfonylurea (SFU) and Glinides:'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.insulin', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Insulin:'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.sglt_2', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Sodium-glucose co-transporter 2 inhibitors (SGLT2):'))) ?>
<?php echo $this->Form->bootstrapRadioYesNo('DrugAllergy.praml', array('label' => array('class' => 'col-lg-3 control-label', 'text' => '<font color="red">* </font>Pramlintide:'))) ?>
